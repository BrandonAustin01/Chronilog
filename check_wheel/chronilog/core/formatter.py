...
# Register SUCCESS log level style
# ✅ Patch in SUCCESS style only if supported
try:
    RichHandler.LEVEL_STYLES["SUCCESS"] = "bold green"
except AttributeError:
    # Older versions of rich don’t support LEVEL_STYLES
    pass
